...
const NetteTunes = () => {
  ...
  return (
    <div className="h-[790px] bg-gradient-to-br from-purple-900 via-blue-900 to-cyan-900 flex justify-center p-8">
      <div className="w-[800px] bg-gradient-to-br from-white-900 to-gray-800 rounded-xl shadow-2xl overflow-hidden border border-cyan-500/30">
        {/* Header */}
        ...
        <div className="flex">
          {/* Playlist Section */}
          <div className="w-1/3 border-r border-teal-300/20 min-h-screen">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center items-center gap-4 border-t border-teal-300/20 pt-4">
                ...
                <button 
                  className="w-8 h-8 rounded-full flex items-center justify-center text-teal-300 
                ...
                <button 
                  className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full 
