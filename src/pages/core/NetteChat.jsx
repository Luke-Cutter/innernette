...
const NetteChat = () => {
  ...
  return (
    <div className="h-[790px] bg-gradient-to-b from-blue-700 via-teal-600 to-blue-800 p-4">
      <AudioPlayer 
        src={audioState.src} 
        timestamp={audioState.timestamp}
      />
      <div className="h-full w-[780px] mx-auto bg-blue-100 rounded shadow-xl flex flex-col">
        ...
        <div className="flex flex-grow bg-gradient-to-b from-blue-700 via-teal-600 to-blue-800 overflow-scroll">
