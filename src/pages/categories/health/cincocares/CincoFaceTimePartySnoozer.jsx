...
const CincoFaceTimePartySnoozer = () => {
  const productImages = [
    "images/pages/categories/cinco/cincoproducts/CincoFaceTime/device.PNG",
    "images/pages/categories/cinco/cincoproducts/CincoFaceTime/brace.PNG",
    "images/pages/categories/cinco/cincoproducts/CincoFaceTime/earphones.PNG",
    "images/pages/categories/cinco/cincoproducts/CincoFaceTime/sleeping.PNG",
    "images/pages/categories/cinco/cincoproducts/CincoFaceTime/rebate.PNG"
  ];
  ...
  const processSteps = [
    {
      ...
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/fitting.PNG"
    },
    {
      ...
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/audio.PNG"
    },
    {
      ...
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/music.PNG"
    },
    {
      title: "Social Integration",
      description: "Enter any social gathering and immediately begin sleeping",
      warning: "Fish story responses not guaranteed",
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/social.PNG"
    }
  ];
  ...
  const customerReviews = [
    {
      ...
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/guest.PNG",
      verified: true
    },
    {
      text: "Something about a river... Okay... I understand",
      author: "Fish Story Listener",
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/listener.PNG",
      verified: true
    },
    {
      text: "4.36 rebate now? Rebate signing up!",
      author: "Small Business Owner",
      image: "images/pages/categories/cinco/cincoproducts/CincoFaceTime/owner.PNG",
      verified: true
    }
  ];
