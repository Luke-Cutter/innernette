...
const MuzikMayker = () => {
  ...
  return (
    <div className="bg-gray-900 p-8 font-['VT323',_monospace] overflow-hidden">
      ...
      <h4 className="text-white mt-3 flex justify-center">© 1985 CINCO™ CORPORATION -v.1985.1.5.2- PEESS KEY THEN SHIFT TO LOCK MUSIC NOTE!</h4>
    </div>
  );
};
