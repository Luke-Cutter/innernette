      ...
      <main className="max-w-6xl mx-auto p-4">
        ...
        <div className="mb-12">
          <div className="bg-[#4a2618] p-8 rounded-lg shadow-xl border-4 border-[#2e1810]">
            ...
            <ImageCarousel
              images={[
                "images/pages/categories/health/TraggsTrough/TraggLogo.png",
                "images/pages/categories/health/TraggsTrough/Blender.png",
                "images/pages/categories/health/TraggsTrough/Contestant.png",
                "images/pages/categories/health/TraggsTrough/Slop.png"
              ]}
            />
          </div>
        </div>
