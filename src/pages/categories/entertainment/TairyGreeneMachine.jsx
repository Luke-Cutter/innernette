...
import { Droplet, Zap, Star, PlayCircle, Phone, DollarSign, Drama, Tv, Heart, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200">
      ...
      <header className="relative overflow-hidden text-white min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-4 py-16 flex flex-col items-center text-center relative z-10">
          ...
          <div className="group bg-gradient-to-r from-red-600 to-red-700 text-white px-12 py-6 rounded-full animate-pulse transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-red-500/50 cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-xl shadow-xl backdrop-blur-sm">
              <div className="flex items-center mb-6">
                <PlayCircle className="w-8 h-8 text-cyan-400 mr-4" />
      ...
      <section className="relative py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-5xl font-bold text-center mb-16 text-white">
            <span className="relative">
              The Critics Rave
              <Sparkles className="absolute -right-12 top-0 text-yellow-400" />
            </span>
          </h2>
