...
const CleaningAfterCat = () => {
    ...
    const cast = [
        {
            ...
            image: "images/pages/categories/health/CleaningAfterCat/mariabamford.png",
            note: "Has strong feelings about pet responsibility"
        },
        {
            name: "Matt",
            role: "Ex-Boyfriend/Guest",
            image: "images/pages/categories/health/CleaningAfterCat/matt.png",
    ...
    return (
        <Channel5Layout
            ...
            showImage="images/pages/categories/health/CleaningAfterCat/CleaningAfterCatLogo.png"
